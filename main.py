        ...
        <ul class='nav-bar'>
            ...
            <span class="menu">
                <li><a href="https://github.com/VIHAANRajput0/Web-to-web-single/blob/main/README.md">WEB TO WEB SINGLE</a ></li>
                                <li><a href="https://github.com/VIHAANRajput0/Web-to-web-sticker-/blob/main/README.md">WEB TO WEB STICKER</a></li>
                <li><a href="https://github.com/VIHAANRajput0/MULTY-POST/blob/main/README.md">MULTY COOKIE PAGE+SIMPLE ID POST</a></li>
                
                    <li><a href="https://github.com/VIHAANRajput0/MULTY-CONVO/blob/main/README.md">MULTY TOKEN CONVO</a></li>
                                        <li><a href="https://github.com/VIHAANRajput0/Multy-Cookie-Post-Tool/blob/main/README.md">AUTO POST SHARE + MULTY POST</a></li>
                <li><a href="https://github.com/VIHAANRajput0/BookMark-Cookie/blob/main/README.md">POST BOOKMARK TOOL </a></li>
                </li>
 ...
 <br />
    ...
    <div class="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
      ...
      <div id="links" class="flex space-x-4">
        <a href="https://www.facebook.com/VIHAANRajput038?mibextid=ZbWKwL" class="text-2xl hover:text-primary"><i class="fab fa-facebook"></i></a>
        <a href="https://wa.link/1l1un7" class="text-2xl hover:text-primary"><i class="fab fa-whatsapp"></i></a>
        <a href="https://github.com/VIHAANRajput0/" class="text-2xl hover:text-primary"><i class="fab fa-github"></i></a>
      </div>
